#!/usr/bin/env python3
"""MCP Weather Server using FastMCP - 195 Countries (Command/stdio transport)."""
import httpx
from fastmcp import FastMCP

# All 195 countries with capital coordinates
COUNTRIES = {
...
mcp = FastMCP("weather-mcp-shayan-command")
